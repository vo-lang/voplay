...
function drawBlockKartSnapshot(canvas: HTMLCanvasElement, payload: Uint8Array): void {
...
function blockKartMaterialColor(material: bigint, entity: number): string {
  if (entity >= 100 && entity <= 106) return "#ff4f48";
