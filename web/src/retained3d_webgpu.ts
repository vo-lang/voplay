...
export class WebGpuRetainedRenderer {
  ...
  render(payload: Uint8Array, assets: Iterable<RetainedGpuAsset>): void {
  ...
  #ensureInstanceCapacity(mesh: ResidentMesh, count: number): void {
    if (mesh.instanceCapacity >= count) return;
